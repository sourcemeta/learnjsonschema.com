...
The [`required`]({{< ref "draft7/validation/required" >}}) keyword restricts
...
keyword. The [`required`]({{< ref "draft7/validation/required" >}}) keyword
mandates that certain properties are present (independently of their value),
while the [`properties`]({{< ref "draft7/validation/properties" >}}) keyword
