...
The [`required`]({{< ref "draft4/validation/required" >}}) keyword restricts
...
keyword. The [`required`]({{< ref "draft4/validation/required" >}}) keyword
mandates that certain properties are present (independently of their value),
while the [`properties`]({{< ref "draft4/validation/properties" >}}) keyword
