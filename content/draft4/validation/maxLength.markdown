...
The [`maxLength`]({{< ref "draft4/validation/maxlength" >}}) keyword restricts string instances to consists of an inclusive
...
empty string value instead of setting this keyword to `0`. {{</best-practice>}}
